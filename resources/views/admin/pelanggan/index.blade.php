...
@section('content')
    <div class="space-y-6">
        ...
        {{-- FILTER BAR --}}
        <div
            class="flex flex-col lg:flex-row lg:items-center justify-between gap-4 bg-white p-4 rounded-xl border border-gray-100 shadow-sm">
        ...
        <div class="bg-white border border-gray-100 rounded-xl overflow-hidden shadow-sm flex flex-col min-h-[520px]">
            ...
            {{-- PAGINATION --}}
            <div
                class="px-8 py-6 bg-white border-t border-gray-100 flex flex-col md:flex-row items-center justify-between gap-4">
