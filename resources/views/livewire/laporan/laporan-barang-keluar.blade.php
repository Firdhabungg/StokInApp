        ...
        <div class="flex flex-wrap items-center justify-between gap-4">
            ...
            @if ($canExportReport ?? false)
                <div class="flex gap-2">
                    <a href="{{ route('laporan.barang-keluar.export.excel', ['dariTanggal' => $dariTanggal, 'sampaiTanggal' => $sampaiTanggal]) }}"
                    ...
                    <a href="{{ route('laporan.barang-keluar.export.pdf', ['dariTanggal' => $dariTanggal, 'sampaiTanggal' => $sampaiTanggal]) }}"
