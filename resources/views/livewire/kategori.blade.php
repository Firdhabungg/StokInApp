 <div>
     ...
     <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
         @forelse ($kategoris as $kategori)
             <div
                 class="bg-white rounded-xl shadow-sm border border-gray-100 p-5 hover:shadow-md transition-shadow group">
                 <div class="flex items-start justify-between">
                     ...
                     <div class="flex items-center gap-1 ml-2">
                         ...
                         <form id="delete-form-{{ $kategori->kategori_id }}"
                             action="{{ route('kategori.destroy', $kategori->kategori_id) }}" method="POST"
                             class="inline">
                             @csrf
                             @method('DELETE')
