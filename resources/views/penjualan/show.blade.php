            ...
            @if ($penjualan->bukti_pembayaran)
                <div class="mb-6">
                    ...
                    <a href="{{ asset('storage/' . $penjualan->bukti_pembayaran) }}" target="_blank"
                        ...
                        <img src="{{ asset('storage/' . $penjualan->bukti_pembayaran) }}" alt="Bukti Pembayaran"
                            class="w-32 h-auto rounded-lg border shadow-sm group-hover:shadow-md transition cursor-zoom-in object-contain">
                        <p class="text-xs text-blue-600 mt-1 text-center group-hover:underline">Klik untuk melihat ukuran
                            penuh</p>
                    </a>
                </div>
            @endif
