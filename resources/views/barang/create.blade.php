<div>
    ...
    <div class="bg-white rounded-lg shadow-sm border border-gray-200 p-6">
        <div class="mb-6">
            <h2 class="text-xl font-semibold text-gray-900">{{ $isEdit ? 'Form Edit Barang' : 'Form Tambah Barang' }}
            </h2>
        ...
        <form wire:submit="save" class="space-y-5">
            ...
            <div>
                ...
                <input type="text" wire:model.lazy="nama_barang" placeholder="Indomie Goreng"
            ...
            <div class="flex justify-end gap-3 pt-2">
                ...
                @endif
                <button type="button" wire:click.prevent="saveOnly"
                    ...
                    <svg wire:loading wire:target="saveOnly" aria-hidden="true"
                        class="w-4 h-4 text-neutral-quaternary animate-spin fill-brand" viewBox="0 0 100 101"
                        fill="none" xmlns="http://www.w3.org/2000/svg">
                        <path
                            d="M100 50.5908C100 78.2051 77.6142 100.591 50 100.591C22.3858 100.591 0 78.2051 0 50.5908C0 22.9766 22.3858 0.59082 50 0.59082C77.6142 0.59082 100 22.9766 100 50.5908ZM9.08144 50.5908C9.08144 73.1895 27.4013 91.5094 50 91.5094C72.5987 91.5094 90.9186 73.1895 90.9186 50.5908C90.9186 27.9921 72.5987 9.67226 50 9.67226C27.4013 9.67226 9.08144 27.9921 9.08144 50.5908Z"
                    ...
                    <span class="sr-only">Loading...</span>
                    {{ $isEdit ? 'Update Barang' : 'Tambah Barang' }}
                </button>
