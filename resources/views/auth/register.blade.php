                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                            <div class="md:col-span-2">
                                ...
                                <input type="text" name="name" id="name" value="{{ old('name') }}" autofocus
                                    class="w-full px-4 py-2 border text-sm {{ $errors->has('name') ? 'border-red-500' : 'border-gray-300' }} rounded-lg focus:ring-2 focus:ring-amber-500 focus:border-amber-500 transition-colors"
                            ...
                            <div>
                                ...
                                <input type="email" name="email" id="email" value="{{ old('email') }}"
                                    class="w-full px-4 py-2 text-sm border {{ $errors->has('email') ? 'border-red-500' : 'border-gray-300' }} rounded-lg focus:ring-2 focus:ring-amber-500 focus:border-amber-500 transition-colors"
                            ...
                            <div>
                                ...
                                <input type="password" name="password" id="password"
                                    class="w-full px-4 py-2 text-sm border {{ $errors->has('password') ? 'border-red-500' : 'border-gray-300' }} rounded-lg focus:ring-2 focus:ring-amber-500 focus:border-amber-500 transition-colors"
                            ...
                            <div>
                                ...
                                <input type="password" name="password_confirmation" id="password_confirmation"
                                    class="w-full px-4 py-2 text-sm border {{ $errors->has('password_confirmation') ? 'border-red-500' : 'border-gray-300' }} rounded-lg focus:ring-2 focus:ring-amber-500 focus:border-amber-500 transition-colors"
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                            <div>
                                ...
                                <input type="text" name="toko_name" id="toko_name" value="{{ old('toko_name') }}"
                                    class="w-full px-4 py-2 text-sm border {{ $errors->has('toko_name') ? 'border-red-500' : 'border-gray-300' }} rounded-lg focus:ring-2 focus:ring-amber-500 focus:border-amber-500 transition-colors"
                            ...
                            <div>
                                ...
                                <input type="email" name="toko_email" id="toko_email" value="{{ old('toko_email') }}"
                                    class="w-full px-4 py-2 text-sm border {{ $errors->has('toko_email') ? 'border-red-500' : 'border-gray-300' }} rounded-lg focus:ring-2 focus:ring-amber-500 focus:border-amber-500 transition-colors"
                            ...
                            <div>
                                ...
                                <input type="tel" name="toko_phone" id="toko_phone" value="{{ old('toko_phone') }}"
                                    class="w-full px-4 py-2 border text-sm {{ $errors->has('toko_phone') ? 'border-red-500' : 'border-gray-300' }} rounded-lg focus:ring-2 focus:ring-amber-500 focus:border-amber-500 transition-colors"
                            ...
                            <div class="md:col-span-2">
                                ...
                                <textarea name="toko_address" id="toko_address" rows="3"
                                    class="w-full px-4 py-2 border text-sm {{ $errors->has('toko_address') ? 'border-red-500' : 'border-gray-300' }} rounded-lg focus:ring-2 focus:ring-amber-500 focus:border-amber-500 transition-colors resize-none"
                ...
                <div class="mt-6 text-center">
                    <p class="text-gray-600">
                        ...
                        <a href="{{ route('login') }}" wire:navigate
                            class="text-amber-600 hover:text-amber-700 font-semibold">Masuk di
                            sini</a>
                    </p>
                </div>
            </div>
