        ...
        <div class="flex flex-wrap items-end justify-between gap-4">
            ...
            @if($canExportReport ?? false)
                <div class="flex gap-2">
                    <a href="{{ route('laporan.barang-masuk.export.excel', ['dari' => $dari, 'sampai' => $sampai]) }}" class="inline-flex items-center px-4 py-2 bg-green-600 hover:bg-green-700 text-white rounded-lg font-medium transition-colors">
                        <i class="fas fa-file-excel mr-2"></i> Excel
                    </a>
                    <a href="{{ route('laporan.barang-masuk.export.pdf', ['dari' => $dari, 'sampai' => $sampai]) }}" class="inline-flex items-center px-4 py-2 bg-red-600 hover:bg-red-700 text-white rounded-lg font-medium transition-colors">
